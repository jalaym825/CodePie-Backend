...
const testCaseSchema = z.object({
    input: z.string({required_error: "Test case input is required"}).min(1, "Test case input is required"),
    output: z.string({required_error: "Test case output is required"}).min(1, "Test case output is required"),
    explanation: z.string().optional(),
    isHidden: z.boolean({required_error: "Hidden status is required"}).default(false),
...
const problemSchema = z.object({
    ...
    difficultyLevel: z.enum(["EASY", "MEDIUM", "HARD"], {required_error: "Difficulty level is required"}),
    ...
    contestId: z.string({required_error: "Contest id is required"}),
    testCases: z.array(testCaseSchema, {required_error: "Test cases is required"})
